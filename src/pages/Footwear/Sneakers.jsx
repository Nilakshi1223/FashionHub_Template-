...
const Sneakers = () => {
  ...
  return (
    ...
    //   >
    //     <div className="max-w-7xl mx-auto px-6 text-center">
    //       <h1 className="text-4xl font-bold text-teal-400">Sneakers Collection</h1>
    //       <p className="mt-2 text-teal-200">Discover our latest trendy sneakers.</p>
    //     </div>
    //   </motion.section>
    ...
    //             onClick={() => setLikedIndex(index)}
    //           >
    //             <FiHeart className={`text-lg ${likedIndex === index ? "text-white" : "text-teal-400"}`} />
    //           </button>
    //         </div>
    //         <div className="p-4">
    //           <h3 className="text-lg font-semibold text-gray-100">{item.title}</h3>
