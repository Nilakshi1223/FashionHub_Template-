...
//   {/* Hero Section */}
//   <motion.section
//     className="bg-gradient-to-r from-gray-950 via-gray-900 to-pink-950"
//     initial={{ opacity: 0, y: 50 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ duration: 0.8 }}
//   >
//     <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 py-16 gap-10">
//       <div className="md:w-1/2 text-center md:text-left">
//         <h1 className="text-5xl font-bold text-pink-400">About FashionHub</h1>
...
//     <div className="max-w-7xl mx-auto px-6 text-center">
//       <h2 className="text-3xl font-bold text-pink-400">Love Notes</h2>
//       <p className="text-gray-400 mt-2">Hear what our clients say about us</p>

//       <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
//         {feedbacks.map((fb, index) => (
//           <motion.div
//             key={index}
//             className="bg-gray-900 rounded-2xl shadow-xl p-6 flex flex-col items-center relative"
//             whileHover={{ scale: 1.05 }}
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: index * 0.2, duration: 0.5 }}
//           >
//             {/* Quote Icon */}
//             <FaQuoteLeft className="text-pink-600 text-3xl absolute top-4 left-4" />
...
//             {/* Message */}
//             <p className="text-gray-300 text-sm mt-4">{fb.message}</p>

//             {/* Name */}
//             <h3 className="mt-4 font-semibold text-lg text-pink-400">{fb.name}</h3>
...
//     <div className="max-w-7xl mx-auto px-6 text-center">
//       <h2 className="text-3xl font-bold text-pink-400">Our Mission</h2>
