...
//               Elegant & <span className="text-teal-300">Trendy</span>
//             </h1>
//             <p className="text-teal-200 text-lg">
//               Explore a curated collection of stylish fashion pieces for women.
//               From dresses to tops and sarees, find your perfect look today.
//             </p>
//             <Link
//               to="/women/dresses"
