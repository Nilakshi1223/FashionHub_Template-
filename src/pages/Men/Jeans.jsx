...
const Jean = () => {
  ...
  useEffect(() => {
    const fetchJeans = async () => {
      try {
        const res = await api.get("/items/read.php?mainCategory=Men&category=Jeans");
  ...
  return (
    ...
    //   >
    //     <div className="max-w-7xl mx-auto px-6 text-center">
    //       <h1 className="text-4xl font-bold text-blue-400">Men's Jeans</h1>
    //       <p className="mt-2 text-gray-300">Trendy and comfortable jeans for everyday wear.</p>
    //     </div>
    //   </motion.section>
    ...
    //         <div className="p-4">
    //           <h3 className="text-lg font-semibold text-gray-100">{jean.title}</h3>
    //           <p className="text-blue-400 font-bold mt-2">Rs. {jean.price}</p>
    //           <p className="text-sm text-gray-400 mt-1">⭐ {jean.rating} / 5</p>
    //         </div>
    //       </motion.div>
    //     ))}
    //   </div>
  ...
  //     >
  //       <div className="max-w-7xl mx-auto px-6 text-center">
  //         <h1 className="text-4xl font-bold text-teal-400">Men's Jeans</h1>
  ...
  //           <div className="p-4">
  //             <h3 className="text-lg font-semibold text-teal-100">{jean.title}</h3>
  //             <p className="text-teal-400 font-bold mt-2">Rs. {jean.price}</p>
  //             <p className="text-sm text-teal-200 mt-1">⭐ {jean.rating} / 5</p>
  //           </div>
  //         </motion.div>
  //       ))}
  //     </div>
